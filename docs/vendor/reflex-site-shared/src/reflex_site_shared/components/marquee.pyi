"""Stub file for reflex_site_shared/components/marquee.py"""
...
class Marquee(rx.NoSSRComponent):
    ...
    def create(
        cls,
        *children,
        auto_fill: Var[bool] | bool | None = None,
        play: Var[bool] | bool | None = None,
        pause_on_hover: Var[bool] | bool | None = None,
        pause_on_click: Var[bool] | bool | None = None,
        direction: Literal["down", "left", "right", "up"]
        | Var[Literal["down", "left", "right", "up"]]
        | None = None,
        speed: Var[int] | int | None = None,
        delay: Var[int] | int | None = None,
        loop: Var[int] | int | None = None,
        gradient: Var[bool] | bool | None = None,
        gradient_color: Var[str] | str | None = None,
        gradient_width: Var[int | str] | int | str | None = None,
        ...
        **props,
        ...
        Args:
            *children: The children of the component.
            auto_fill: Behavior props
            play: no description
            pause_on_hover: no description
            pause_on_click: no description
            direction: no description
            speed: Animation props
            delay: no description
            loop: no description
            gradient: Gradient props
            gradient_color: no description
            gradient_width: no description
